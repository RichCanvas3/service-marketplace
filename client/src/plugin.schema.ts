export const schema = {
  "ICredentialIssuerEIP1271": {
    "components": {
      "schemas": {
        "ICreateVerifiableCredentialEIP1271Args": {
          "type": "object",
          "properties": {
            "resolutionOptions": {
              "type": "object",
        ...
        "ICreateVerifiablePresentationEIP1271Args": {
          "type": "object",
          "properties": {
            "resolutionOptions": {
              "type": "object",
          ...
          "description": "Encapsulates the parameters required to create a  {@link https://www.w3.org/TR/vc-data-model/#presentations | W3C Verifiable Presentation }  using the  {@link https://w3c-ccg.github.io/ethereum-eip1271-signature-2021-spec/ | EthereumEip1271Signature2021 }  proof format."
        },
        "PresentationPayload": {
          "type": "object",
          "properties": {
        ...
        "IVerifyPresentationEIP1271Args": {
          "type": "object",
          "properties": {
            "resolutionOptions": {
              "type": "object",
      ...
      "methods": {
        "createVerifiableCredentialEIP1271": {
          ...
          "arguments": {
            "$ref": "#/components/schemas/ICreateVerifiableCredentialEIP1271Args"
          },
          "returnType": {
            "$ref": "#/components/schemas/VerifiableCredential"
          }
        ...
        "createVerifiablePresentationEIP1271": {
          ...
          "arguments": {
            "$ref": "#/components/schemas/ICreateVerifiablePresentationEIP1271Args"
          },
          "returnType": {
            "$ref": "#/components/schemas/VerifiablePresentation"
          }
        },
        "verifyCredentialEIP1271": {
          "description": "Verifies a Verifiable Credential in EIP1271 Format.",
          "arguments": {
            "$ref": "#/components/schemas/IVerifyCredentialEIP1271Args"
          },
          "returnType": {
            "type": "boolean"
          }
        },
        "verifyPresentationEIP1271": {
          "description": "Verifies a Verifiable Presentation EIP1271 Format.",
          "arguments": {
            "$ref": "#/components/schemas/IVerifyPresentationEIP1271Args"
          },
          "returnType": {
            "type": "boolean"
          }
